...
class ServerOrder extends Widget
{
    ...
    public function run()
    {
        ...
        return Html::tag('div', Progress::widget([
            ...
            'options' => ['class' => 'active progress-striped', 'style' => 'width: 800px; margin: 0 auto;'],
        ]), ['id' => 'server-order-app']);
    }
...
//        $this->view->registerJs("ReactDOM.render(React.createElement(ServerOrder), document.querySelector('#server-order-root'));", View::POS_END);
//        $this->view->jsFiles[View::POS_END][null] = Html::script("ReactDOM.render(React.createElement(ServerOrder), document.querySelector('#server-order-root'));", ['type' => 'text/babel']);
    }
