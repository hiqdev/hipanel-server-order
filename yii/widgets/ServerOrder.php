...
class ServerOrder extends Widget
{
    ...
    private function applyJs(): void
    {
        ...
        $themeBundle = $this->view->assetManager->getBundle(ServerOrderAdvancedhostingThemeAsset::class);
        $this->view->registerJsVar('hipanel_server_order_path_to_icons', $themeBundle->baseUrl . DIRECTORY_SEPARATOR);
        $this->view->registerJsVar('hipanel_server_order', [
            ...
            'configs' => $this->groupConfigsByLocation(),
            'osImages' => $this->osimages,
        ]);
    }

    private function groupConfigsByLocation(): array
    {
        $configsByLocation = [];
