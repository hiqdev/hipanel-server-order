...
//        $a = iterator_to_array($this->configOptions());
        $this->view->registerJsVar('hipanel_order_server', [
            ...
            'administrationOptions' => $this->administrationOptions(),
            'softpackOptions' => $this->softpackOptions(),
        ]);
    }
    ...
    private function softpackOptions()
    {
        return [
            [
                'name' => 'hipanel',
